...
#     ocp.add_plot(
#         "My New Extra Plot",
#         lambda t0, phases_dt, node_idx, x, u, p, a, d: custom_plot_callback(
#             x, [0, 1, 3]
#         ),
...
#     #     "/home/klbonnet/Documents/bioptim/bioptim/examples/getting_started/save_folder",
...
def main():
    ...
    biorbd_model_path = ExampleUtils.folder + "/models/pendulum.bioMod"
    ocp = prepare_ocp(
        biorbd_model_path=biorbd_model_path, final_time=2, n_shooting=1000
    )
    ...
    # --- Solve the program --- #
    # sol = ocp.solve(Solver.IPOPT(show_online_optim=True, online_optim=False))
    sol = ocp.solve(Solver.IPOPT(show_online_optim=True))
...
if __name__ == "__main__":
    ...
    # fichier_pkl = "/home/klbonnet/Documents/bioptim/bioptim/examples/getting_started/save_folder/result_file_name_1.pkl"
